...
class Encoder : public ODriveIntf::EncoderIntf {
   public:
    ...
    struct Config_t {
        ...
        void set_use_index(bool value) {
            use_index = value;
            parent->set_idx_subscribe();
        }
        void set_find_idx_on_lockin_only(bool value) {
            find_idx_on_lockin_only = value;
            parent->set_idx_subscribe();
        }
        ...
        void set_pre_calibrated(bool value) {
            ...
            parent->check_pre_calibrated();
        }
        void set_bandwidth(float value) {
            bandwidth = value;
            parent->update_pll_gains();
        }
    };
